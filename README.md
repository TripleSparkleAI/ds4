...
Regenerate, never hand-edit. Regenerated 2026-09-18 00:13Z, 28 cards.

```
  branch                           status      best delta  latest  verdict
  triple-all-fastest               POSITIVE       +12.31%  r10     TIES
  triple-hitsfirst                 POSITIVE       +12.31%  r10     TIES
  triple-pool                      POSITIVE        +9.59%  r9      TIES
  triple-all                       POSITIVE        +7.02%  r9      TIES
  triple-winners                   POSITIVE        +6.86%  r10     BEATS
  triple-all-fastest-newtip        POSITIVE        +6.64%  r9      TIES
  triple-pair                      POSITIVE        +5.58%  r10     BEATS
