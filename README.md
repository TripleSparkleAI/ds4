...
Regenerate, never hand-edit. Regenerated 2026-09-18 10:00Z, 28 cards.
...
```
  ...
  triple-hitsfirst                 POSITIVE             -  -       -           -  (v2 card, not yet converted)
...
### triple-hitsfirst (v2 card, not yet converted)
