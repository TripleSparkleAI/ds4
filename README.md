...
Regenerate, never hand-edit. Regenerated 2026-09-18 10:14Z, 28 cards.
...
```
  ...
  triple-pool-and-hitsfirst        POSITIVE        +5.58%  r10     BEATS       1
  ...
  triple-spec-under-offload        NEGATIVE             -  -       -           0
  triple-draft-gamma               NOT YET         +3.83%  r5      TIES        1
  triple-engram-4bit               NOT YET              -  -       -           0
...
```
  ...
  r9                     10.11     9.42   +7.02%   3/4  17.27  TIES     4
  r8                      9.10     8.96   -0.98%   1/4  10.69  TIES     4
  r6                     10.35     9.69   +6.50%   3/3   3.35  BEATS    3
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r8 85.3 vs tip 84.3
  files   r9 2026-09-17-R9-RESULT-*.md · r8 2026-09-17-R8-RESULT-*.md
          r6 2026-09-17-R6-RESULT-*.md
```
...
```
  ┌─ triple-all-fastest-newtip ──────────────────────────────── POSITIVE
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r9                      9.93     9.42   +3.77%   2/3  17.27  TIES     3
  r8     readahead ON     9.80     8.96   +6.64%   3/4  10.69  TIES     4
  r8     hits ON          9.36     8.96   +5.46%   4/4  10.69  TIES     4
  r8     both ON          8.64     8.96   -5.95%   0/4  10.69  TIES     4
  r4                     10.14     9.65   +4.65%   4/4   2.71  BEATS    4
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r4 136.3 vs tip 80.7
  files   r9 2026-09-17-R9-RESULT-*.md · r8 2026-09-17-R8-RESULT-*.md
          r4 2026-09-17-R4-RESULT-*.md
```
...
```
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r4                      9.87     9.65   +2.28%   3/3   2.71  PARTIAL  3
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r4 138.7 vs tip 80.7
...
```
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r12    QD=16           10.35     9.54  +10.25%   4/4   3.81  BEATS    4
  r10                    10.40     9.73   +6.53%   3/4   2.18  BEATS    4
  r10    QD=16           10.40     9.73   +6.86%   4/4   2.18  BEATS    4
  r9                     10.20     9.42   +5.03%   3/3  17.27  TIES     3
  r8                      9.18     8.96   +1.54%   2/3  10.69  TIES     3
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r8 135.1 vs tip 84.3
  files   r12 2026-09-18-R12-RESULT-*.md · r10 2026-09-18-R10-RESULT-*.md
          r9 2026-09-17-R9-RESULT-*.md · r8 2026-09-17-R8-RESULT-*.md
```
...
```
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r5                      9.62     9.60   +1.48%   3/4   5.69  TIES     4
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r5 87.5 vs tip 84.6
  files   r5 2026-09-17-R5-RESULT-*.md
```
...
```
  ┌─ triple-engram-read-threads ───────────────────────────── WORTH ZERO
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r4                      9.60     9.65   -1.39%   1/4   2.71  TIES     4
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r4 82.6 vs tip 80.7
  files   r4 2026-09-17-R4-RESULT-*.md
```
...
```
  ┌─ triple-hippocampal-warmset ───────────────────────────── WORTH ZERO
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r6                      9.57     9.69   -1.54%   0/3   3.35  TIES     3
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: 83.97 t/s median against the tip's 89.16, n=4; no prefill verdict in round 6
  files   r6 2026-09-17-R6-RESULT-*.md
```
...
```
  ┌─ triple-lfu-offsetkey ─────────────────────────────────── WORTH ZERO
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r6                      9.71     9.69   -0.20%   1/3   3.35  TIES     3
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: 85.90 t/s median against the tip's 89.16, n=4; no prefill verdict in round 6
  files   r6 2026-09-17-R6-RESULT-*.md
```
...
```
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r5                      9.73     9.60   +1.47%   4/4   5.69  TIES     4
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r5 83.6 vs tip 84.6
  files   r5 2026-09-17-R5-RESULT-*.md
```
...
```
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r5                      9.51     9.60   -0.04%   2/4   5.69  TIES     4
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r5 86.0 vs tip 84.6
  files   r5 2026-09-17-R5-RESULT-*.md
```
...
```
  ┌─ triple-prefill-readahead-order ─────────────────────────── NEGATIVE
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r4                      8.55     9.65  -11.38%   0/4   2.71  LOSES    4
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r4 86.3 vs tip 80.7
  files   r4 2026-09-17-R4-RESULT-*.md
```
...
```
  ...
  RESULTS   gen tokens/s at min across ctx 4096 and 6144 · DGX Spark GB10
  round  variant       arm t/s  tip t/s    delta  sign  floor  verdict  n
  r5                      9.75     9.60   +3.83%   4/4   5.69  TIES     4
  each repeat against its two bracketing tip runs · floor = max adjacent tip pair
  prefill: r5 88.6 vs tip 84.6
  files   r5 2026-09-17-R5-RESULT-*.md
```
