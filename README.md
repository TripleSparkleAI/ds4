...
Regenerate, never hand-edit. Regenerated 2026-09-18 00:18Z, 28 cards.

```
  branch                           status      best delta  latest  verdict  rows
  triple-all-fastest               POSITIVE       +12.31%  r10     TIES        4
  triple-hitsfirst                 POSITIVE       +12.31%  r10     TIES        4
  triple-pool                      POSITIVE        +9.59%  r9      TIES        3
  triple-all                       POSITIVE        +7.02%  r9      TIES        3
  triple-winners                   POSITIVE        +6.86%  r10     BEATS       4
