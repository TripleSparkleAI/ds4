...
test-rocm:
	$(MAKE) -B ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test \
		test-session-state \
		tests/test_layer_pack tests/test_prefill_hold tests/test_engine_mgpu_placement tests/test_gpu_args tests/test_prompt_prefix \
...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test test-session-state test-linux-memory test-engram test-web-recovery \
	tests/test_layer_pack tests/test_prefill_hold tests/test_engine_mgpu_placement tests/test_gpu_args \
