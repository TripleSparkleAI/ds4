...
test-rocm:
	$(MAKE) -B ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test \
		test-session-state \
		tests/test_layer_pack tests/test_hitsfirst_logic tests/test_scout_logic tests/test_jev_router_logic tests/test_engine_mgpu_placement tests/test_gpu_args tests/test_prompt_prefix \
	...
	./tests/test_hitsfirst_logic
	./tests/test_scout_logic
	./tests/test_jev_router_logic
...
tests/test_hitsfirst_logic: tests/test_hitsfirst_logic.c ds4_hitsfirst_logic.h
	$(CC) $(CFLAGS) -I. -o $@ $< $(LDLIBS)

tests/test_scout_logic: tests/test_scout_logic.c ds4_scout_logic.h
	$(CC) $(CFLAGS) -I. -o $@ $< $(LDLIBS)

tests/test_jev_router_logic: tests/test_jev_router_logic.c ds4_jev_router_logic.h
	$(CC) $(CFLAGS) -I. -o $@ $< $(LDLIBS)
...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test test-session-state test-linux-memory test-engram test-web-recovery \
	tests/test_layer_pack tests/test_hitsfirst_logic tests/test_scout_logic tests/test_jev_router_logic tests/test_engine_mgpu_placement tests/test_gpu_args \
