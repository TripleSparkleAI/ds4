...
# lever, both keeps ours then theirs, bothrev the reverse. Diff3 bases (||||||| blocks)
# are skipped: the manifest records a decision between two sides, not a three-way replay.
#
